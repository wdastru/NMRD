...
!      SUBROUTINE paranmrdorig(FILEINPUT, II, XYOUTPUT, JJ)
!      SUBROUTINE paranmrdorig(FILEINPUT, II, XYOUTPUT, JJ, PAROUTPUT, KK)
      SUBROUTINE paranmrdorig(FILEINPUT, XYOUTPUT, PAROUTPUT)
...
!  XYOUTPUT = THE XY OUTPUT FILE
!  PAROUTPUT = THE PARAMETERS OUTPUT FILE
...
!     XY OUTPUT FILE
      READ(1,'(A)')XYOUTPUT						! WD 15/11/2015
!     PARAMETERS OUTPUT FILE
      READ(1,'(A)')PAROUTPUT                    ! WD 11/07/2017

      OPEN (4, FILE = PAROUTPUT)                    ! WD 11/07/2017
...
!     CALCULATION OF THE CURVE
      OPEN (44, FILE = XYOUTPUT) ! XYOUTPUT WAS FILENAME IN ORIGINAL FILE (WD) 
      DO K=1,SET
          NPT(K)=NUMPUN
      END DO
      INDEXSTAMPA=1
