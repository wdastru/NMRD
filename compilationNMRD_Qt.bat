...
echo Linking ... 
c:\MinGW\bin\g++.exe -o test_nmrd_subroutineC_Qt build/nmrd_subroutineF_new.o build/WidgetForm.o build/nmrd_subroutineC_Qt.o build/moc_WidgetForm.o -L%QT%\lib -lgfortran -lQtGui4 -lQtCore4
